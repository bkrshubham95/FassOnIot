...
#ifndef GOOGLE_PROTOBUF_INCLUDED_pub_5fsub_5fmessages_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_pub_5fsub_5fmessages_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_pub_5fsub_5fmessages_2eproto
...
struct TableStruct_pub_5fsub_5fmessages_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_pub_5fsub_5fmessages_2eproto;
class Message;
...
class Message PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_pub_5fsub_5fmessages_2eproto);
    return ::descriptor_table_pub_5fsub_5fmessages_2eproto.file_level_metadata[kIndexInFileMessages];
  }
 ...
 private:
  ...
  friend struct ::TableStruct_pub_5fsub_5fmessages_2eproto;
};
// ===================================================================
...
inline std::string* Message::unsafe_arena_release_topic() {
  // @@protoc_insertion_point(field_unsafe_arena_release:Message.topic)
...
inline void Message::unsafe_arena_set_allocated_topic(
  ...
  topic_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      topic, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:Message.topic)
}
...
inline std::string* Message::unsafe_arena_release_payload() {
  // @@protoc_insertion_point(field_unsafe_arena_release:Message.payload)
  GOOGLE_DCHECK(GetArena() != nullptr);
...
inline void Message::unsafe_arena_set_allocated_payload(
  ...
  payload_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      payload, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:Message.payload)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_pub_5fsub_5fmessages_2eproto
